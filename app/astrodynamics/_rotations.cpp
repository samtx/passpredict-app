...
static PyObject *__pyx_pf_3app_13astrodynamics_10_rotations_razel(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_location_lat_rad, double __pyx_v_location_lon_rad, __Pyx_memviewslice __pyx_v_location_ecef, __Pyx_memviewslice __pyx_v_satellite_ecef); /* proto */
...
/* "app/astrodynamics/_rotations.pyx":10
 * 
 * 
 * def razel(             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_3app_13astrodynamics_10_rotations_1razel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3app_13astrodynamics_10_rotations_razel[] = "\n    Get range, azimuth, and elevation of satellite relative for observing location\n    ";
static PyMethodDef __pyx_mdef_3app_13astrodynamics_10_rotations_1razel = {"razel", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3app_13astrodynamics_10_rotations_1razel, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3app_13astrodynamics_10_rotations_razel};
static PyObject *__pyx_pw_3app_13astrodynamics_10_rotations_1razel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("app.astrodynamics._rotations.razel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3app_13astrodynamics_10_rotations_razel(__pyx_self, __pyx_v_location_lat_rad, __pyx_v_location_lon_rad, __pyx_v_location_ecef, __pyx_v_satellite_ecef);
...
static PyObject *__pyx_pf_3app_13astrodynamics_10_rotations_razel(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_location_lat_rad, double __pyx_v_location_lon_rad, __Pyx_memviewslice __pyx_v_location_ecef, __Pyx_memviewslice __pyx_v_satellite_ecef) {
  double __pyx_v_rx;
  double __pyx_v_ry;
  double __pyx_v_rz;
  ...
  /* "app/astrodynamics/_rotations.pyx":25
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":26
 * 
 *     rx = satellite_ecef[0] - location_ecef[0]
 *     ry = satellite_ecef[1] - location_ecef[1]             # <<<<<<<<<<<<<<
 *     rz = satellite_ecef[2] - location_ecef[2]
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":27
 *     rx = satellite_ecef[0] - location_ecef[0]
 *     ry = satellite_ecef[1] - location_ecef[1]
 *     rz = satellite_ecef[2] - location_ecef[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":29
 *     rz = satellite_ecef[2] - location_ecef[2]
 * 
 *     sin_location_lat = sin(location_lat_rad)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":30
 * 
 *     sin_location_lat = sin(location_lat_rad)
 *     cos_location_lat = cos(location_lat_rad)             # <<<<<<<<<<<<<<
 *     sin_location_lon = sin(location_lon_rad)
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":34
 *     cos_location_lon = cos(location_lon_rad)
 * 
 *     top_s = (sin_location_lat * cos_location_lon * rx) + (sin_location_lat * sin_location_lon * ry) - (cos_location_lat * rz)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":39
 * 
 *     range_ = sqrt(top_s*top_s + top_e*top_e + top_z*top_z)
 *     el = asin(top_z / range_)             # <<<<<<<<<<<<<<
 *     az = atan2(-top_e, top_s) + pi
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":40
 *     range_ = sqrt(top_s*top_s + top_e*top_e + top_z*top_z)
 *     el = asin(top_z / range_)
 *     az = atan2(-top_e, top_s) + pi             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":43
 * 
 *     # convert radians to degrees
 *     el_deg = el * 180.0 / pi             # <<<<<<<<<<<<<<
 *     az_deg = az * 180.0 / pi
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":44
 *     # convert radians to degrees
 *     el_deg = el * 180.0 / pi
 *     az_deg = az * 180.0 / pi             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "app/astrodynamics/_rotations.pyx":46
 *     az_deg = az * 180.0 / pi
 * 
 *     return (range_, az_deg, el_deg)             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(4, 0, 19, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_app_astrodynamics__rotations_pyx, __pyx_n_s_razel, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 *     double location_lon_rad,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3app_13astrodynamics_10_rotations_1razel, NULL, __pyx_n_s_app_astrodynamics__rotations); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
