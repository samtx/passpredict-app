try:
    from app.astrodynamics._rotations import (
        mod2ecef,
        teme2ecef,
        ecef2sez,
    )
except ImportError as e:
    msg = 'Compile extensions with Cython first'
    raise e(msg)
...
#     """
#     phi_rad = phi * constants.DEG2RAD
#     lmda_rad = lmda * constants.DEG2RAD
#     ang1 = (90 - phi) * constants.DEG2RAD
